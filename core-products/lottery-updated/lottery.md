...
* Lottery Ticket Fee for 1 ticket: 10 PIE 
* Single User Lottery Entry Limit: No limit
* Paying for one ticket \(10 PIE\) will give users a random 4 digit combination with each digit being between 1-10, for e.g. “1-9-3-2”
